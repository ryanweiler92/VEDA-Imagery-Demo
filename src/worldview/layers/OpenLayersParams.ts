...
export const urls = {
    ...
    ctURL1 : "https://d1nzvsko7rbono.cloudfront.net/mosaic/tiles/287c7ac3d034019c51ec96dff14e4c6a/WGS1984Quad/{z}/{x}/{y}@1x?assets=B07&assets=B05&assets=B04&post_process=swir",

    ctURL2 : "https://kv9drwgv6l.execute-api.us-west-2.amazonaws.com/mosaic/tiles/287c7ac3d034019c51ec96dff14e4c6a/WGS1984Quad/{z}/{x}/{y}@1x?post_process=swir&assets=B07&assets=B05&assets=B04",

    presetFIRMS: "https://d1nzvsko7rbono.cloudfront.net/mosaic/tiles/4c640d25fd8dd78aef47721a71ee8e96/WGS1984Quad/9/561/132@1x?assets=B07&assets=B05&assets=B04&post_process=swir",
...
export const resolutions = {
    nineResolutions: [0.5625, 0.28125, 0.140625, 0.0703125, 0.03515625, 0.017578125, 0.0087890625, 0.00439453125, 0.002197265625]
}
...
export const configMatrixSets = {
    configTwoKmMatrixSet: configSources.geoConfigSource.matrixSets[matrixSets.twoKmMatrixSet]
}
