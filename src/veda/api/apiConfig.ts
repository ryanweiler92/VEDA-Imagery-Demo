export const apiCalls = [
    ...
    },
    {
        ...
        url: "customRequest",
        description: "collection=HLSS30, bbox=n/a, temporalRange=7/1/18-10/28/21, bandCombo=B07/B05/B04, post_process=swir, minzoom=9, maxzoom=14, You should be able to pan anywhere on a Leaflet map and if zoomed enough should render tiles, These specific parameters don't seem to work well on OL map",
        customReference: "11",
        applyToMap: true
    },
    {
        ...
        url: "customRequest",
        description: "collection=HLSS30, bbox=n/a, temporalRange=3/15/2022, bandCombo=B07/B05/B04, post_process=swir, minzoom=9, maxzoom=14, You should be able to pan anywhere on both maps and if zoomed enough should render tiles",
        customReference: "12",
        applyToMap: true
    },
    {
    ...
    },
    {
        ...
        url: "customRequest",
        description: "collection=HLSL30, bbox=n/a, temporalRange=01/01/2022, bandCombo=B07/B05/B04, post_process=swir, minzoom=9, maxzoom=14, You should be able to pan anywhere on both maps and if zoomed enough should render tiles",
        customReference: "14",
        applyToMap: true
    },
    {
        ...
        url: "customRequest",
        description: "collection=HLSS30, bbox=n/a, temporalRange=app date, bandCombo=B07/B05/B04, post_process=swir, minzoom=9, maxzoom=14, You should be able to pan anywhere on both maps and if zoomed enough should render tiles",
        customReference: "15",
        applyToMap: true
    },
