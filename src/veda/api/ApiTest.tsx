...
const ApiTest = () => {
  ...
  const fetchLocalStorage = (e) => {
    if (e.target.id == "test1") {
      ...
      if (!lsData) {
        console.log("No data found in local storage for response 1.");
      }
      ...
      if (!lsData) {
        console.log("No data found in local storage for response 2.");
      }
      const response = JSON.parse(lsData);
      ...
      if (!lsData) {
        console.log("No data found in local storage for response 3.");
      }
      const response = JSON.parse(lsData);
